...
export function ScrollNav({ items, brand, brandHref, actions, localeSwitcher, authActions }: Props) {
  ...
  return (
    <>
      {/* ═══ Mobile header ═══ */}
      <header className="sticky top-2 z-100 mx-4 flex h-14 items-center justify-between rounded-full border border-slate-200 bg-white/95 px-5 text-slate-900 shadow-[0_4px_16px_rgba(0,0,0,0.15)] backdrop-blur-md md:hidden dark:border-slate-800 dark:bg-slate-950/95 dark:text-white">
      ...
      {/* ═══ Desktop navbar ═══ */}
      <nav className="sticky top-4 z-100 hidden mx-4 md:mx-auto w-[96%] max-w-[1536px] rounded-full border border-slate-200 bg-white/95 shadow-[0_4px_16px_rgba(0,0,0,0.15)] backdrop-blur-md md:block dark:border-slate-800 dark:bg-slate-950/95">

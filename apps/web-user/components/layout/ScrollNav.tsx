            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  childActive
                    ? "border border-slate-200 bg-white text-primary-500 shadow-[0_3px_0_rgb(203,213,225),0_4px_8px_rgba(0,0,0,0.04)] -translate-y-[1px] dark:border-slate-700 dark:bg-slate-800 dark:text-primary-400"

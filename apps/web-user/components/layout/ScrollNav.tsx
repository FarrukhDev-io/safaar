...
export function ScrollNav({ items, brand, brandHref, actions, localeSwitcher, authActions }: Props) {
  ...
  return (
    <>
      {/* ═══ Mobile header ═══ */}
      <header className="mt-2 sticky top-2 z-100 mx-4 flex h-14 items-center justify-between rounded-2xl border border-slate-200 bg-white/95 px-5 text-slate-900 shadow-sm backdrop-blur-md md:hidden dark:bg-slate-950/95 dark:text-white dark:border-slate-800">
      ...
      {/* ═══ Desktop navbar ═══ */}
      <nav className="mt-4 sticky top-4 z-100 hidden mx-4 md:mx-auto w-[96%] max-w-[1536px] rounded-2xl border border-slate-200 bg-white/95 shadow-sm backdrop-blur-md md:block dark:border-slate-800 dark:bg-slate-950/95">

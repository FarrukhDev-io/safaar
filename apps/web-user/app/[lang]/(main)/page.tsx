            ...
            <div className="mx-auto mt-4 flex max-w-5xl flex-nowrap items-center justify-start sm:justify-center gap-2 overflow-x-auto px-4 py-4 sm:mt-6 scrollbar-none">
              {cities.slice(0, 8).map((city) => (
                <Link
                  ...
                  className="shrink-0 rounded-full border border-slate-200 bg-white px-5 py-2.5 text-sm font-bold text-slate-700 shadow-[0_0_10px_rgba(0,0,0,0.05)] transition-all duration-200 hover:border-primary-500 hover:text-primary-600 hover:shadow-[0_0_15px_rgba(0,0,0,0.1)] active:scale-95"
                >
                  {city.name}
                </Link>
              ))}

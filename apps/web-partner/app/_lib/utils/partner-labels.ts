...
const BUS_LABELS: PartnerLabels = {
  ...
  dashboardEyebrow: "Bugungi reys va qatnovlar",
  unitSingular: "transport",
  unitPlural: "transportlar",
  addUnitLabel: "Yangi transport qo'shish",
  reservationLabel: "Bron",
  reservationsTitle: "Bronlar va Chiptalar",
  topbarSubtitle: "Transport boshqaruv paneli",
  calendarTitle: "Qatnovlar Jadvali",
  calendarDescription: "Barcha yo'nalishlar bo'yicha mashina va transport qatnovlarini kuzating.",
  unitsPageTitle: "Transport Parki (Avtomobillar)",
  unitsPageDescription: "Tashuvchi kompaniyangizdagi barcha mashina va transport vositalari.",
  listingTitle: "Kompaniya E'loni",
  checkInLabel: "Jo'nash vaqti",
  checkOutLabel: "Yetib kelish vaqti",
  guestLabel: "Yo'lovchi / Mijoz",
  frontDeskTitle: "Dispetcherlik",
  frontDeskDescription: "Bugungi bronlar, qatnovlar va operatsion vazifalar.",
  unitsMapTitle: "Transport Parki",
  availabilityLabel: "Faol qatnovlar",
  entityTypeLabel: "Yo'nalishlar",
  unitTypeLabel: "Transport turi",
  unitTypesTitle: "Transport Turlari",
  newBookingLabel: "Yangi bron",
  walkInTitle: "Bevosita bron (Kassa)",
